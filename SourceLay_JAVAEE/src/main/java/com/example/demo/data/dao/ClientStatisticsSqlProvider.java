...
import com.example.demo.data.model.ClientStatisticsExample.Criteria;
import com.example.demo.data.model.ClientStatisticsExample.Criterion;
import com.example.demo.data.model.ClientStatisticsExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ClientStatisticsSqlProvider {
    public String countByExample(ClientStatisticsExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("CLIENT_STATISTICS");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(ClientStatisticsExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("CLIENT_STATISTICS");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(ClientStatistics record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("CLIENT_STATISTICS");
        
        if (record.getClient() != null) {
            sql.VALUES("CLIENT", "#{client,jdbcType=VARCHAR}");
        }
        
        if (record.getTotalConnections() != null) {
            sql.VALUES("TOTAL_CONNECTIONS", "#{totalConnections,jdbcType=BIGINT}");
        }
        
        if (record.getConcurrentConnections() != null) {
            sql.VALUES("CONCURRENT_CONNECTIONS", "#{concurrentConnections,jdbcType=BIGINT}");
        }
        
        if (record.getConnectedTime() != null) {
            sql.VALUES("CONNECTED_TIME", "#{connectedTime,jdbcType=BIGINT}");
        }
    ...
    public String selectByExample(ClientStatisticsExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("CLIENT");
        } else {
            sql.SELECT("CLIENT");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ClientStatistics record = (ClientStatistics) parameter.get("record");
        ClientStatisticsExample example = (ClientStatisticsExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("CLIENT_STATISTICS");
        
        if (record.getClient() != null) {
            sql.SET("CLIENT = #{record.client,jdbcType=VARCHAR}");
        }
        
        if (record.getTotalConnections() != null) {
            sql.SET("TOTAL_CONNECTIONS = #{record.totalConnections,jdbcType=BIGINT}");
        }
        
        if (record.getConcurrentConnections() != null) {
            sql.SET("CONCURRENT_CONNECTIONS = #{record.concurrentConnections,jdbcType=BIGINT}");
        }
        
        if (record.getConnectedTime() != null) {
            sql.SET("CONNECTED_TIME = #{record.connectedTime,jdbcType=BIGINT}");
        }
    ...
    protected void applyWhere(SQL sql, ClientStatisticsExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
