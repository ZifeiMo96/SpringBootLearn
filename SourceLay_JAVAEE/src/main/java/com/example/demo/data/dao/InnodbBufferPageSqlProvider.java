...
import com.example.demo.data.model.InnodbBufferPageExample.Criteria;
import com.example.demo.data.model.InnodbBufferPageExample.Criterion;
import com.example.demo.data.model.InnodbBufferPageExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class InnodbBufferPageSqlProvider {
    public String countByExample(InnodbBufferPageExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(InnodbBufferPageExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("INNODB_BUFFER_PAGE");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(InnodbBufferPage record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("INNODB_BUFFER_PAGE");
        ...
        if (record.getBlockId() != null) {
            sql.VALUES("BLOCK_ID", "#{blockId,jdbcType=BIGINT}");
        }
        ...
        if (record.getPageState() != null) {
            sql.VALUES("PAGE_STATE", "#{pageState,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(InnodbBufferPageExample example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("PAGE_STATE");
        sql.SELECT("IO_FIX");
        sql.SELECT("IS_OLD");
        sql.SELECT("FREE_PAGE_CLOCK");
        sql.FROM("INNODB_BUFFER_PAGE");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        InnodbBufferPage record = (InnodbBufferPage) parameter.get("record");
        InnodbBufferPageExample example = (InnodbBufferPageExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("INNODB_BUFFER_PAGE");
        ...
        if (record.getBlockId() != null) {
            sql.SET("BLOCK_ID = #{record.blockId,jdbcType=BIGINT}");
        }
        ...
        if (record.getPageState() != null) {
            sql.SET("PAGE_STATE = #{record.pageState,jdbcType=VARCHAR}");
        }
    ...
    protected void applyWhere(SQL sql, InnodbBufferPageExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
