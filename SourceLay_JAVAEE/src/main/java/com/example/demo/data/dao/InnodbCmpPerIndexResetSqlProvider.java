...
import com.example.demo.data.model.InnodbCmpPerIndexResetExample.Criteria;
import com.example.demo.data.model.InnodbCmpPerIndexResetExample.Criterion;
import com.example.demo.data.model.InnodbCmpPerIndexResetExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class InnodbCmpPerIndexResetSqlProvider {
    public String countByExample(InnodbCmpPerIndexResetExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(InnodbCmpPerIndexResetExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("INNODB_CMP_PER_INDEX_RESET");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(InnodbCmpPerIndexReset record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("INNODB_CMP_PER_INDEX_RESET");
    ...
    public String selectByExample(InnodbCmpPerIndexResetExample example) {
        SQL sql = new SQL();
        ...
        sql.FROM("INNODB_CMP_PER_INDEX_RESET");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        InnodbCmpPerIndexReset record = (InnodbCmpPerIndexReset) parameter.get("record");
        InnodbCmpPerIndexResetExample example = (InnodbCmpPerIndexResetExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("INNODB_CMP_PER_INDEX_RESET");
    ...
    protected void applyWhere(SQL sql, InnodbCmpPerIndexResetExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
