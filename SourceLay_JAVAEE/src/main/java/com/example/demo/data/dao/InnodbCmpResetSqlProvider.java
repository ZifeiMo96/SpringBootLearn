...
import com.example.demo.data.model.InnodbCmpResetExample.Criteria;
import com.example.demo.data.model.InnodbCmpResetExample.Criterion;
import com.example.demo.data.model.InnodbCmpResetExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class InnodbCmpResetSqlProvider {
    public String countByExample(InnodbCmpResetExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(InnodbCmpResetExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("INNODB_CMP_RESET");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(InnodbCmpReset record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("INNODB_CMP_RESET");
    ...
    public String selectByExample(InnodbCmpResetExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        InnodbCmpReset record = (InnodbCmpReset) parameter.get("record");
        InnodbCmpResetExample example = (InnodbCmpResetExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("INNODB_CMP_RESET");
    ...
    protected void applyWhere(SQL sql, InnodbCmpResetExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
