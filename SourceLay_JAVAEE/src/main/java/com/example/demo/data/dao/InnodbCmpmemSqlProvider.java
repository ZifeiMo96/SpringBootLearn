...
import com.example.demo.data.model.InnodbCmpmemExample.Criteria;
import com.example.demo.data.model.InnodbCmpmemExample.Criterion;
import com.example.demo.data.model.InnodbCmpmemExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class InnodbCmpmemSqlProvider {
    public String countByExample(InnodbCmpmemExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(InnodbCmpmemExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("INNODB_CMPMEM");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(InnodbCmpmem record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("INNODB_CMPMEM");
    ...
    public String selectByExample(InnodbCmpmemExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        InnodbCmpmem record = (InnodbCmpmem) parameter.get("record");
        InnodbCmpmemExample example = (InnodbCmpmemExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("INNODB_CMPMEM");
    ...
    protected void applyWhere(SQL sql, InnodbCmpmemExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
