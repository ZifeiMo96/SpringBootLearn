...
import com.example.demo.data.model.SchemaPrivilegesExample.Criteria;
import com.example.demo.data.model.SchemaPrivilegesExample.Criterion;
import com.example.demo.data.model.SchemaPrivilegesExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class SchemaPrivilegesSqlProvider {
    public String countByExample(SchemaPrivilegesExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("SCHEMA_PRIVILEGES");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(SchemaPrivilegesExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("SCHEMA_PRIVILEGES");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(SchemaPrivileges record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("SCHEMA_PRIVILEGES");
    ...
    public String selectByExample(SchemaPrivilegesExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SchemaPrivileges record = (SchemaPrivileges) parameter.get("record");
        SchemaPrivilegesExample example = (SchemaPrivilegesExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("SCHEMA_PRIVILEGES");
    ...
    protected void applyWhere(SQL sql, SchemaPrivilegesExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
