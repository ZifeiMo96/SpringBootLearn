...
import com.example.demo.data.model.UserPrivilegesExample.Criteria;
import com.example.demo.data.model.UserPrivilegesExample.Criterion;
import com.example.demo.data.model.UserPrivilegesExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class UserPrivilegesSqlProvider {
    public String countByExample(UserPrivilegesExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("USER_PRIVILEGES");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(UserPrivilegesExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("USER_PRIVILEGES");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(UserPrivileges record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("USER_PRIVILEGES");
    ...
    public String selectByExample(UserPrivilegesExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        UserPrivileges record = (UserPrivileges) parameter.get("record");
        UserPrivilegesExample example = (UserPrivilegesExample) parameter.get("example");
    ...
    protected void applyWhere(SQL sql, UserPrivilegesExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
