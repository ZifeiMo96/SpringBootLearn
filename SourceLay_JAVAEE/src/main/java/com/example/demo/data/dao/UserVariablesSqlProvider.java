...
import com.example.demo.data.model.UserVariablesExample.Criteria;
import com.example.demo.data.model.UserVariablesExample.Criterion;
import com.example.demo.data.model.UserVariablesExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class UserVariablesSqlProvider {
    public String countByExample(UserVariablesExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("user_variables");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(UserVariablesExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("user_variables");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(UserVariables record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("user_variables");
    ...
    public String selectByExample(UserVariablesExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        UserVariables record = (UserVariables) parameter.get("record");
        UserVariablesExample example = (UserVariablesExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("user_variables");
    ...
    protected void applyWhere(SQL sql, UserVariablesExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
