...
public class Plugins {
    ...
    public String getPluginMaturity() {
        return pluginMaturity;
    }

    public void setPluginMaturity(String pluginMaturity) {
        this.pluginMaturity = pluginMaturity == null ? null : pluginMaturity.trim();
    }

    public String getPluginAuthVersion() {
        return pluginAuthVersion;
    }

    public void setPluginAuthVersion(String pluginAuthVersion) {
        this.pluginAuthVersion = pluginAuthVersion == null ? null : pluginAuthVersion.trim();
    }
